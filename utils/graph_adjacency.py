...
def get_miss_adjacency(features1, features2, mask, n, topk=10):
    ...
    dist_1, dist_2 = get_similarity_matrix(features1, 'heat'), get_similarity_matrix(features2, 'heat')
    # dist_1, dist_2 = get_similarity_matrix(features1, 'cos'), get_similarity_matrix(features2, 'cos')
    dist1, dist2 = transfer_S(dist_1, dist_2, mask)
    # dist_1, dist_2 = get_similarity_matrix(features1, 'cos'), get_similarity_matrix(features2, 'cos')
