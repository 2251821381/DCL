...
def get_config(flag):
    ...
    if data_name in ['Scene-15']:
        return dict(
            ...
            Autoencoder=dict(
                gcnEncoder1=[40, 1024, 1024, 1024, 1024 // 2],#2
        ...
        return dict(
            ...
            Autoencoder=dict(
                gcnEncoder1=[59, 1024, 1024, 1024, 1024 // 4],#4
        ...
        return dict(
            ...
            Autoencoder=dict(
                gcnEncoder1=[576, 1024, 1024, 1024, 1024 // 8],#8
        ...
        return dict(
            ...
            Autoencoder=dict(
                gcnEncoder1=[76, 1024, 1024, 1024, 1024 // 2],#2
